...
class listingPhotoGallery extends React.Component {
  ...
  componetWillMount () {
    this.props.fetchPhotos(listingId)
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(listingPhotoGallery);
